    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FamilyGroupsId = table.Column<int>(type: "int", nullable: false),
                    UsersId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserFamilyGroups", x => new { x.FamilyGroupsId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_UserFamilyGroups_FamilyGroups_FamilyGroupsId",
                        column: x => x.FamilyGroupsId,
                        principalTable: "FamilyGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserFamilyGroups_Users_UsersId",
                        column: x => x.UsersId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VaccineCategoryVaccines", x => new { x.CategoriesId, x.VaccinesId });
                    table.ForeignKey(
                        name: "FK_VaccineCategoryVaccines_VaccineCategories_CategoriesId",
                        column: x => x.CategoriesId,
                        principalTable: "VaccineCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VaccineCategoryVaccines_Vaccines_VaccinesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VaccineCategoryVaccines_VaccinesId",
